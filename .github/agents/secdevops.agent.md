...
- **Inputs:** [SECURITY.md](../../docs/SECURITY.md) `NFR-##`; policy baselines from [Enterprise Architect](./enterprise-architect.agent.md); code/IaC from [Developer](./developer.agent.md); eval fixtures from [ATC Domain Expert](./atc-domain-expert.agent.md) / [Responsible-AI Officer](./responsible-ai-officer.agent.md).
...
## Handoffs
- ← [Developer (AG-E-02)](./developer.agent.md): code/IaC to scan, test, and deploy.
- ↔ [Enterprise Architect (AG-E-03)](./enterprise-architect.agent.md): policy-as-code, network/segregation controls, sign-off dependencies.
- ↔ [Responsible-AI Officer (AG-E-06)](./responsible-ai-officer.agent.md): wire content-safety + fairness/read-back **eval gates** into CI.
- ← [ATC Domain Expert (AG-E-05)](./atc-domain-expert.agent.md): golden fixtures consumed by the eval gate.
