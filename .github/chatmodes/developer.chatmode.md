...
4. **Tests (TDD):** write failing tests first — unit, **contract tests against the OpenAPI schema**, and integration tests including the **golden phraseology set** ([AI.md](../../docs/AI.md) §7) supplied by the [ATC Domain Expert](./atc-domain-expert.chatmode.md).
...
- **Inputs:** stories + acceptance criteria from [Product Owner](./product-owner.chatmode.md); [SD.md](../../docs/SD.md); [../../api/openapi.yaml](../../api/openapi.yaml); [BOM.md](../../docs/BOM.md) service/region choices; golden fixtures from [ATC Domain Expert](./atc-domain-expert.chatmode.md); security controls from [SecDevOps](./secdevops.chatmode.md).
...
- IaC deploys cleanly via `azd`; **no secrets in code** (Key Vault + managed identity); IaC scan clean ([SecDevOps](./secdevops.chatmode.md), `NFR-16`).
...
## Handoffs
- ← [Product Owner (AG-E-01)](./product-owner.chatmode.md): stories/acceptance criteria.
- ↔ [Enterprise Architect (AG-E-03)](./enterprise-architect.chatmode.md): confirm patterns vs [SD.md](../../docs/SD.md)/ADRs; raise architecturally-significant changes.
- → [SecDevOps (AG-E-04)](./secdevops.chatmode.md): CI/CD, security scanning, release gates.
- ← [ATC Domain Expert (AG-E-05)](./atc-domain-expert.chatmode.md): golden fixtures & command-schema semantics.
- ↔ [Responsible-AI Officer (AG-E-06)](./responsible-ai-officer.chatmode.md): eval hooks, content safety, disclosure UX.
